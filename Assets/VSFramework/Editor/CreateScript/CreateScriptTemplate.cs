...
namespace LGui.LGame
{
    ...
    {
        [MenuItem("Assets/VSFramework/Create/CreateScript",false,0)]
    ...
    class CreateScriptAsset : EndNameEditAction
    {
        ...
        UnityEngine.Object CreateScriptAssetTemplate(string pathName, string resourceFile)
        {
            ...
            ScriptTemplateConfig scriptTemplate = new ScriptTemplateConfig();  //EditorUntil.GetConfig<ScriptTemplateConfig>();
